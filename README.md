...
Bem-vindo ao repositório do Nubble App, o projeto foi construído nas aulas do curso [PRN (Profissional React Native)](https://coffstack.com.br/profissional-react-native). Ao longo do desenvolvimento, foram aprendidos conceitos práticos utilizados no mercado de trabalho, desde o básico até o avançado. Durante esse processo, foi construído um super App com integração com Backend, **testes automatizados**, pipelines de **CI/CD** com GitHub Actions, Fastlane, e amplo uso de **TypeScript**!


![Project](https://github.com/user-attachments/assets/c0882536-f020-49ed-a5b4-ec49b22cdf64)
...
![Project](https://github.com/user-attachments/assets/5aaa320c-280f-422f-aed6-05ddc082f8c9)
